...
import AnnotableReviewerCommentListItem from './annotable-reviewer-comment-list-item';
...
/**
 * General (not in context) revision request for `ReviewAction` (`action`)
 * - requests are stored in `action.comment`
 */
class AnnotableReviewerCommentList extends React.Component {
  static propTypes = {
    id: PropTypes.string,
