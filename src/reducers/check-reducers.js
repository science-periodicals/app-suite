...
import {
  FETCH_ACTIVE_CHECKS,
  FETCH_ACTIVE_CHECKS_SUCCESS,
  FETCH_ACTIVE_CHECKS_ERROR,
  POST_CHECK_ACTION_SUCCESS
...
export function activeCheckActions(
  state = {
    data: [],
    nextUrl: null,
  ...
  switch (action.type) {
    ...
    case POST_CHECK_ACTION_SUCCESS: {
...
export function fetchActiveCheckActionsStatus(
  state = { xhr: null, isActive: false, error: null },
  action
) {
  switch (action.type) {
    case FETCH_ACTIVE_CHECKS:
    ...
    case FETCH_ACTIVE_CHECKS_ERROR:
      return {
        xhr: null,
        isActive: false,
        error: action.error
